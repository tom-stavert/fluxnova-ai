...
public record HistoricTaskInstanceResultDto(
    ...
    public static HistoricTaskInstanceResultDto fromHistoricTaskInstance(HistoricTaskInstance hti) {
        return new HistoricTaskInstanceResultDto(
                hti.getId(),
                hti.getProcessDefinitionKey(),
                hti.getProcessDefinitionId(),
                hti.getRootProcessInstanceId(),
                hti.getProcessInstanceId(),
                hti.getExecutionId(),
                hti.getCaseDefinitionKey(),
                hti.getCaseDefinitionId(),
                hti.getCaseInstanceId(),
                hti.getCaseExecutionId(),
                hti.getActivityInstanceId(),
                hti.getName(),
                hti.getDescription(),
                hti.getDeleteReason(),
                hti.getOwner(),
